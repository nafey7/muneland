...
exports.EditCardStrategyAndVision = async (req,res, next) => {
    try{
...
exports.EditCardEntSolutionPlaybook = async (req,res,next) => {
    try{
        if (!req.body.zonetext1 || !req.body.zonetext2 || !req.body.zonetext3 || !req.body.zonetext4 || !req.body.rate || !req.body.days){
            throw new Error('Please fill all the fields');
        }
...
exports.EditCardLeadershipAndSocialization = async (req,res,next) => {
    try{
        if (!req.body.zonetext1 || !req.body.zonetext2 || !req.body.zonetext3 || !req.body.zonetext4 || !req.body.rate || !req.body.days){
            throw new Error('Please fill all the fields');
        }
